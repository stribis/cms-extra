...
class Dashboard extends Controller
{
   ...
   * @param int
   * @return array
   * ? Returns an array of news by calling the DashboardModel fetchPost method...
   **/
   ...
   * @param int
   * @return null|void
   * ? Redirects user to dashboard after deleting the given post
   **/
   ...
   * @param array
   * @return array
   * ? Redirects user to dashboard after creating the given post
   **/
